                ...
                >
                    ...
                    {isHomepage ? (
                        <React.Fragment>
                            ...
                            <div className={classNames(styles.section, styles.homeBrand)}>
                                <img
                                ...
                                <p>
                                    <FormattedMessage
                                        // eslint-disable-next-line max-len
                                        defaultMessage="{APP_TAGLINE} Built on TurboWarp — compile Scratch projects to JavaScript and run real Python on the stage."
