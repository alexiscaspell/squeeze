...
const squeezeWebpack = require('./webpack.squeeze');

const scratchBlocksMedia = path.resolve(__dirname, '../../node_modules/scratch-blocks/media');
...
const base = {
    ...
    resolve: {
        symlinks: false,
        extensions: squeezeWebpack.getResolveExtensions(),
        alias: {
            'text-encoding$': path.resolve(__dirname, 'src/lib/tw-text-encoder'),
            'scratch-render-fonts$': path.resolve(__dirname, 'src/lib/tw-scratch-render-fonts'),
            ...squeezeWebpack.getResolveAlias()
        }
    },
    module: {
        rules: [{
            ...
            include: [
                ...
                squeezeWebpack.getBabelInclude(),
...
module.exports = [
    ...
    defaultsDeep({}, base, {
        entry: {
            ...
            ...squeezeWebpack.getExtraEntries()
        },
        output: {
        ...
        plugins: base.plugins.concat([
            new webpack.DefinePlugin({
                ...
                ...squeezeWebpack.getDefinePluginValues()
            }),
            ...squeezeWebpack.getExtraPlugins(),
