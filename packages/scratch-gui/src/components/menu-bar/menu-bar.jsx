            ...
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        {this.props.logo && (
                            <div
                                className={classNames(
                                    styles.menuBarItem,
                                    styles.logoItem,
                                    this.props.onClickLogo && styles.hoverable
                                )}
                            >
                                <img
                                    id="logo_img"
                                    ...
                                    className={classNames(
                                        styles.scratchLogo,
                                        this.props.onClickLogo && styles.clickable
                                    )}
                                    draggable={false}
                                    src={this.props.logo}
                        ...
                        <div
                            className={classNames(styles.menuBarItem, styles.hoverable, styles.pythonButton)}
                            onClick={() => {
                                if (window.__squeezeTogglePythonPanel) {
                                    window.__squeezeTogglePythonPanel();
                                }
                            }}
